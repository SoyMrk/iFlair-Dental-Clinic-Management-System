...
Public Class NextAppointment
    ...
    Private Sub NextAppointment_Load(sender As Object, e As EventArgs) Handles Me.Load

        txtboxPatientNo.Text = PatientRecordScreen.MyPatientID
        txtboxPatientName.Text = PatientRecordScreen.PatientName
        txtboxDentistName.Text = PatientAppointmentHistory.nameDentist
        ...
        'sqlstr = "SELECT p.LastName, a.StartTime, a.EndTime FROM appointment a " _
        '      & "INNER JOIN patient p ON a.PatientID = p.PatientID " _
        '      & "WHERE a.AppDate = '" & dtpickerAppDate.Text & "' AND (a.AppStatus = ""Scheduled"" or a.AppStatus = ""Rescheduled"") "
        'MsgBox(sqlstr)
    ...
    Private Sub NextAppointment_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
    ...
    Private Sub txtboxDentistName_TextChanged(sender As Object, e As EventArgs) Handles txtboxDentistName.TextChanged
