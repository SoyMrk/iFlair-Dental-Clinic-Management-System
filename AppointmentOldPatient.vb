...
Public Class AppointmentOldPatient
    ...
    Private Sub txtboxSearchPatient_TextChanged(sender As Object, e As EventArgs) Handles txtboxSearchPatient.TextChanged
        ...
        Me.datagridOldPatientApp.Rows.Clear()
        ...
        While myreader.Read()
            Me.datagridOldPatientApp.Rows.Add(New Object() {myreader.Item("PatientID"), myreader.Item("LastName"), myreader.Item("FirstName"), myreader.Item("MiddleName"), myreader.Item("Street")})
        End While
    ...
    Private Sub AppointmentOldPatient_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub datagridOldPatientApp_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles datagridOldPatientApp.CellContentClick

        txtboxPatientNo.Text = datagridOldPatientApp.CurrentRow.Cells(0).Value.ToString
        ...
        With sqlcmd
            Try
                ...
                While myreader.Read()
                    ...
                    txtboxPatientName.Text = myreader("FirstName") + " " + myreader("LastName")
    ...
    'Appointment old patient table mouse hover move
    Private Sub datagridOldPatientApp_CellMouseMove(sender As Object, e As DataGridViewCellMouseEventArgs) Handles datagridOldPatientApp.CellMouseMove

        datagridOldPatientApp.ClearSelection()
        If e.RowIndex > -1 Then
            datagridOldPatientApp.Rows(e.RowIndex).Selected = True
        End If
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If dtpickerAppDate.Value < Date.Today Then
            MsgBox("Enter a date later than today")
            Exit Sub
        End If

        If cmbboxDentist.Text = "" Then
            MsgBox("Dentist Name Cannot be Empty")
            cmbboxDentist.Select()
            Exit Sub
        End If

        If txtboxPatientNo.Text = "" Then
            MsgBox("Please Select a Patient in the table above")
            Exit Sub
        End If
